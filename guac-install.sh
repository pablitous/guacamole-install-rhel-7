...
# USER CONFIGURABLE #
# Generic
SCRIPT_BUILD="2021_09_27" # Scripts Date for last modified as "yyyy_mm_dd"
...
{[ -f /etc/nginx/conf.d/default.conf ] && mv /etc/nginx/conf.d/default.conf /etc/nginx/conf.d/default.conf.ori.bkp; } &
